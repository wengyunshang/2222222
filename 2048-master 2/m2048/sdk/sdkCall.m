...
//    NSDate *date = self.oauth.expirationDate;
    
//    [temptime1 timeIntervalSinceDate:temptime2] < 0.0
    
    [[NSNotificationCenter defaultCenter] postNotificationName:kLoginSuccessed object:self];
    NSLog(@"openid:%@",self.oauth.openId);
...
//        NSMutableString *str=[NSMutableString stringWithFormat:@""];
        ...
        self.logo = [response.jsonResponse objectForKey:@"figureurl_2"];
